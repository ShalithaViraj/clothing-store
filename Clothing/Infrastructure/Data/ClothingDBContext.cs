...
{
    public class ClothingDBContext : DbContext, IClothingDBContext
    {
        private readonly AuditableEntitySaveChangerInterceptor _auditableEntitySaveChangesInterceptor;
        private IDbContextTransaction dbContextTransaction;

        public ClothingDBContext(DbContextOptions<ClothingDBContext> options,
            AuditableEntitySaveChangerInterceptor auditableEntitySaveChangesInterceptor) : base(options)
        {
